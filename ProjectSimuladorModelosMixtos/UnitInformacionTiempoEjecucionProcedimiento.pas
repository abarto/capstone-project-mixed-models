...
uses
  Classes, Contnrs,
  UaMatriz, UnitArregloEnteros, UnitEfecto, UnitOpcion, UnitParametros,
...
type
  ...
  public
    {** Cantidad de niveles del efecto. }
    CantidadNiveles: Integer;
    {** Cantidad de niveles inexistentes (no encontrados en los datos.) }
