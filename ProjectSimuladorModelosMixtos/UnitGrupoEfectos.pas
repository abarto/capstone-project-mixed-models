...
type
  {** Grupo de efectos aleatorios de modelos mixtos. Es utilizado para
      describir tanto el bloque de efectos fijos, como los bloques de los
      efectos aleatorios y grupos de los mismos. Cada grupo contiene una lista
      de efectos y una lista de opciones asociada al bloque.
      @abstract(Grupo de efectos.) }
  TGrupoEfectos = class
  private
    {** Efectos del grupo. }
