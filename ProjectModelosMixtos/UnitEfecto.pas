...
type
  {** function (const Item1, Item2: String): Integer of object;
      Tipo de funciones para comparar dos variables. Se utiliza para reordenar
      los efectos y las lista de efectos anidados. Item1 e item2 son los
      identificadores de variables. La funcion devuelve <0 si item1 es menor
      que item2, 0 si item1 es igual a item2 y >0 si item1 es mayor que
      item2.) }
