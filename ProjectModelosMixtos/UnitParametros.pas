...
type
  ...
  public
    ...
    {** Valida el vector de parametros verificando si los valores de los mismos
        ...
        superiores.)
        @param(Llamador Metodo desde el cual fue llamado.)
        @returns(Devuelve @true si los valores del arreglo estan dentro de las
        cotas especificadas o @false en caso contrario.) }
    function Validar(var Bitacora: TStrings; const VerificarCotasInferiores: Boolean; const VerificarCotasSuperiores: Boolean; const Llamador: String): Boolean; virtual;
...
function TArregloParametros.Validar(var Bitacora: TStrings; const VerificarCotasInferiores: Boolean; const VerificarCotasSuperiores: Boolean; const Llamador: String): Boolean;
var
  I: Integer;
  Cabecera: String;
begin { TArregloParametros.Validar }
  ...
  begin
    ...
    begin
      ...
      begin
        Bitacora.Add(Cabecera + 'El valor del parametro ' + IntToStr(I) + ' ("' + FInformacionParametros [I].Nombre + '") ' + FloatToStr(FValores [FInformacionParametros [I].Indice]) + ' viola su cota inferior: ' + FInformacionParametros [I].Texto);
        Result := False;
      end;
  ...
  begin
    ...
    begin
      ...
      begin
        Bitacora.Add(Cabecera + 'El parametro "' + FInformacionParametros [I].Nombre + '" (' + IntToStr(I) + ') viola su cota superior: ' + FInformacionParametros [I].Texto);
        Result := False;
      end;
